...
export default function Home() {
  ...
  return (
    <body><Header titulo="Squirtle" />
      <main>
        <CardSection h2="Informações sobre Squirtle">
        <div>
          <img
        ...
        <CardSection h2="Características">
        <p>
        ...
        <CardSection h2="Squirtle: O Amigo Aquático">
        <p>
        ...
        <CardSection h2="Recursos Adicionais" >
        <ul>
          <li>
            <a
